...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Novo Formulário</h1>
        ...
        <!-- Formulário -->
        <form action="{{ route('eventos.formularios.store', $evento) }}" method="POST" id="formulario-form">
            @csrf
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div>
                            ...
                            <textarea name="mensagem_sucesso" rows="3"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('mensagem_sucesso') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div id="campos-container" class="space-y-4 min-h-[400px]">
                            ...
                            <div id="campos-empty" class="text-center py-16 text-gray-400">
